...
namespace projecttremopo {
	...
	/// </summary>
	public ref class signin_form_driver : public System::Windows::Forms::Form
	{
	public:
		signin_form_driver(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Click += gcnew System::EventHandler(this, &signin_form_driver::label1_Click);
			// 
			// label2
			// 
			...
			this->emailidsigninfor->TextChanged += gcnew System::EventHandler(this, &signin_form_driver::emailidsigninfor_TextChanged);
			// 
			// save_signinform
			// 
			...
			this->save_signinform->Click += gcnew System::EventHandler(this, &signin_form_driver::save_signinform_Click);
			// 
			// signin_form_driver
			// 
			...
			this->Name = L"signin_form_driver";
			this->Text = L"signin_form";
			this->Load += gcnew System::EventHandler(this, &signin_form_driver::signin_form_Load);
...
#pragma endregion
	...
	private: System::Void save_signinform_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		std::ofstream outputFile("signindata.text");
		...
		driverform^ t5 = gcnew driverform();
		t5->Show();
		this->Hide();
